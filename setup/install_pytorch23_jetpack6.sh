...
[ ! -f "$TORCH_WHL" ] && wget https://nvidia.box.com/shared/static/zvultzsmd4iuheykxy17s4l2n91ylpl8.whl -O "$TORCH_WHL"
[ ! -f "$TORCHAUDIO_WHL" ] && wget https://nvidia.box.com/shared/static/9si945yrzesspmg9up4ys380lqxjylc3.whl -O "$TORCHAUDIO_WHL"
[ ! -f "$TORCHVISION_WHL" ] && wget https://nvidia.box.com/shared/static/u0ziu01c0kyji4zz3gxam79181nebylf.whl -O "$TORCHVISION_WHL"
