...
TORCH_WHL=torch-2.8.0-cp310-cp310-linux_aarch64.whl
TORCHAUDIO_WHL=torchaudio-2.8.0-cp310-cp310-linux_aarch64.whl
TORCHVISION_WHL=torchvision-0.23.0-cp310-cp310-linux_aarch64.whl
...
[ ! -f "$TORCH_WHL" ] && wget https://pypi.jetson-ai-lab.io/jp6/cu126/+f/62a/1beee9f2f1470/torch-2.8.0-cp310-cp310-linux_aarch64.whl -O "$TORCH_WHL"
[ ! -f "$TORCHAUDIO_WHL" ] && wget https://pypi.jetson-ai-lab.io/jp6/cu126/+f/81a/775c8af36ac85/torchaudio-2.8.0-cp310-cp310-linux_aarch64.whl -O "$TORCHAUDIO_WHL"
[ ! -f "$TORCHVISION_WHL" ] && wget https://pypi.jetson-ai-lab.io/jp6/cu126/+f/907/c4c1933789645/torchvision-0.23.0-cp310-cp310-linux_aarch64.whl -O "$TORCHVISION_WHL"
